...
// Owner information
global.Owner = process.env.OWNER ? process.env.OWNER.split(",") : ["94704012533"];
global.OwnerNumber = process.env.OWNER_NUMBER ? process.env.OWNER_NUMBER.split(",") : ["94704012533"];
global.ownertag = process.env.OWNER_TAG ? process.env.OWNER_TAG.split(",") : ["94704012533"];
global.OwnerName = process.env.OWNER_NAME || "DAGAYA";
